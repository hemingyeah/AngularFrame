//资讯列表
app.controller('NewsCtrl', function($scope, $sce, Dialog, NewsService, manageService, RoleService, service) {
        $scope.dataService = NewsService;
        ...
        var manage = manageService.constructor($scope, $scope.gridOptions, "NewsEditCtrl", "/views/NewsManage/NewsEdit.html");
        $scope.gridOptions.event = $.extend(manage, {
            GroupPush: function(data) {
                ...
                Dialog.Show("/views/NewsManage/NewsGroupPush.html", "NewsGroupPushCtrl", "lg", {
            ...
            PersonalPush: function(data) {
                ...
                Dialog.Show("/views/NewsManage/NewsPersonalPush.html", "NewsPersonalPushCtrl", "lg", {
                    SeletedData: function() {
                        return seletedData;
                    },
                    row: function() {
    ...
    //资讯编辑
app.controller('NewsEditCtrl', function($scope, $sce, $modalInstance, Dialog, DataOperate, NewsService, data) {
        $scope.model = data;
        $scope.event = {
            Save: function() {
                ...
                // $scope.model.NewsLevelName = DataOperate.GetListName($scope.model.FkNewsLevelId, $scope.NewsLevels, "Id", "DisplayName");
                if ($scope.model.Id) {
                    NewsService.PutNews($scope, $.extend($scope.model, {
                        Id: $scope.Id
                    }), function(data) {
                        $modalInstance.close(data);
                    });
                } else {
                    NewsService.PostNews($scope, $scope.model, function(data) {
                        $modalInstance.close(data);
                    });
                }
            },
            ...
            fileChange: function(evt) {
                ...
                Dialog.Show("/views/NewsManage/ImgCrop.html", "ImgCropCtrl", "lg", {
                    File: function() {
    ...
    //个人资讯
app.controller('NewsPersonalPushCtrl', function($scope, $modal, $modalInstance, $sce, Dialog, NewsService, service, RoleService, manageService, SeletedData) {
        ...
        $scope.event = {
            ...
            Push: function() {
                ...
                NewsService.PostPushNews($scope, {
                    NewsIds: newsIds,
                    Recievers: recievers,
                    PushType: 0
                }, function(data) {
    ...
    //群组资讯
app.controller('NewsGroupPushCtrl', function($scope, $modal, $modalInstance, service, NewsService, Dialog, RoleService, manageService, SeletedData) {
        $scope.SeletedData = SeletedData;
        $scope.Page = {
            Index: 1,
            Count: 1
    ...
    //标签资讯
app.controller('TagNewsCtrl', function($scope, NewsService) {
    $scope.Page = {
        Index: 1,
        Count: 1
    }
    $scope.event = {
        LoadData: function() {
            NewsService.GetNewssByUserId($scope, {
        ...
        Delete: function(data) {
            NewsService.DeleteInfo($scope, data, function(data) {
...
app.controller('NewsViewCtrl', function($scope, preview) {
