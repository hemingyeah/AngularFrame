          ...
          modules: [
              {
                name:"zTree",
                files: [
                    "/node_Modules/zTree/js/jquery.ztree.all-3.5.min.js",
              ...
              },
              {
                name:"ngEditor",
                files:[
                    "/node_modules/angular-ueditor/ueditor.config.js",
                    "/node_modules/angular-ueditor/ueditor.all.js",
                    "/node_modules/angular-ueditor/angular-ueditor.min.js"
                ]
              },
              {
                name:"ueditor",
                files:[
                    "/node_modules/ueditor/ueditor.config.js",
                    "/node_modules/ueditor/ueditor.all.js",
                    "/node_modules/ueditor/angular-ueditor.min.js"
                ]
              },
              {
                name:"richText",
                files: [
                    '/vendor/wangEditor/css/wangEditor-1.3.12.css',
                    '/vendor/wangEditor/js/wangEditor-1.3.12.js'
                ]
              },
              {
                  name: 'ui.tree',
                  files: [
                      '/vendor/modules/angular-ui-tree/angular-ui-tree.min.js',
                      '/vendor/modules/angular-ui-tree/angular-ui-tree.min.css'
                  ]
              },
              // {
              //   name:"ui.DateTime",
              //   files: [
              //       "/node_Modules/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js",
              //       "/node_Modules/bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js",
              //       "/node_Modules/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css"
              //   ]
              // },
              {
                  name: 'ngGrid',
              ...
              },
              {
                  name: 'ui.select',
                  files: [
                      '/vendor/modules/angular-ui-select/select.js',
